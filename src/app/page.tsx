    ...
    return (
        <>
            <main>
                ...
                >
                    {/* ✅ Navbar is inside the Hero section */}
                    <Navbar />
                        ...
                        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white bg-opacity-90 text-gray-900 shadow-lg rounded-lg p-6">
                                ...
                                <p className="mt-2">
                                    ...
                                    <strong>Email:</strong>
                                    <a href="mailto:northshiredevelopments@gmail.com" className="text-orange-500 hover:underline"> northshiredevelopments@gmail.com</a>
                                </p>
